<template>
    <div >
        ...
        <div style="position: fixed; top: 44px; left: 0; right: 0;">
  ...
  <svg class="tr-header__middle__site-title__logo" version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 760 76" style="enable-background:new 0 0 760 76; fill:white" xml:space="preserve"
            >
          <g>
              <path d="M1,12.7h4.9c8.7,0,18.4-1,20.4-1.8l1.1,1.3c-1,1.8-1.8,3.6-1.8,9.3v52h11v-52c0-5.7-0.8-7.5-1.8-9.3l1.1-1.3
              c2,0.8,11.7,1.8,20.4,1.8H61V2H1V12.7z"></path>
